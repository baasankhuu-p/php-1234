...
```C
    ...
    PHP төстэй PERL
    - PERL ==> Apache
        * Request - ийн дурын hook-m холбогдох боломжтой. 
        * Ж нь: URL translation hook (url==>virtual host)
            // Үүнийг shared host дээр ISP зөвшөөрөх боломжгүй. Бусдын request-ийг аваад эхэлбэл ...
        * Тиймээс RERL зөвхөн нэг бүтэн физик сэрвэрт нэгл вебийг ажиллууллахад шаардлагатай болох тул үнэтэй байсан
    - PHP ==> Apache
        * Content generation hook
        * ISP ууд PHP - д дуртай байсны шалтгаан
        ...
        * Wordpress гарч ирэх бүр дэлгэрүүлсэн
```