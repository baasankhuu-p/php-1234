                ...
                <div class="card mb-0 shadow-none">
                    <div class="card-body">
                        ...
                        <h3 class="text-center m-0">
                            <a href="/sign-in" class="logo logo-admin"><img src="assets/images/logo-sm.png" height="60"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="remember"
                                                name="remember">
                                            <label class="custom-control-label" for="remember">Намайг
                                                сана</label>
                                        </div>
                                    </div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">© 2022 <?=ucfirst(DOMAIN)?> | Бүтээсэн сурагч <i
                                    class="mdi mdi-heart text-danger"></i>Баасанхүү
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-9 p-0 vh-100  d-flex justify-content-center">
                <div class="accountbg d-flex align-items-center">
                    <div class="account-title text-center text-white">
                        <h4 class="mt-3 text-white">Хувийн санхүү <span class="text-warning"><?=mb_strtoupper(DOMAIN)?>
                            </span> </h4>
                        ...
                        <p class="mt-3 font-size-14">Гэр бүлийнхээ санхүүгийн байдлыг хамгийн хялбараар авч явж, харж
                            дүгнэж, ойлгохыг хүсж байна уу?</p>
